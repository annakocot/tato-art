...
alt: Poza zasięgiem — abstrakcyjna kompozycja Dariusza Kocota
...
en:
  title: Out of Range
  series: ""
  alt: Out of Range — abstract composition by Dariusz Kocot
  description: Out of Range is a geometric composition built from intense colour,
    simple signs and scattered structures resembling fragments of a technical
    interface. The contrast between cool grey, bright green, yellow and black
    creates a space somewhere between a map, a device screen and an abstract
